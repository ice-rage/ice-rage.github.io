(function () {
  ...
  async function initMap() {
    ...
    contactsMap.addChild(new YMapDefaultSchemeLayer({theme: "dark", 
      customization: [
        {
            "tags": "country",
    ...
    // Добавляем слой для отображения маркера поверх карты
    contactsMap.addChild(new YMapDefaultFeaturesLayer({}));

    // Создаем стандартный маркер темно-красного цвета
    const marker = new YMapDefaultMarker({
        coordinates: [84.96274, 56.49385],
        title: "LENNI ART",
        subtitle: "г. Томск, ул. Белая, д. 8",
        color: "#BC3324"
      }
    );
